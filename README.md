For running the search algorithms:

Download all files in this folder before running the programs.
The file generator.py is required for all search algorithms.
